...
import { UserService, NotificationService } from './../../../shared/services/index';
import { MessageConstants } from '../../systems/constants';
import { UsersDetailComponent } from './users-detail/users-detail.component';
import { Pagination, User } from '../../../shared/models';
import { RolesAssignComponent } from './role-assign/role-assign.component';
...
export class UsersComponent implements OnInit {
  ...
  showEditModal() {
    ...
    this.bsModalRef = this.modalService.show(UsersDetailComponent,
      {
        initialState: initialState as  Partial<UsersDetailComponent>,
        class: 'modal-lg',
        backdrop: 'static'
      });
  ...
  addUserRole() {
    ...
    this.bsModalRef = this.modalService.show(RolesAssignComponent,
      {
        initialState: initialState  as  Partial<RolesAssignComponent>, 
        class: 'modal-lg',
        backdrop: 'static'
      });
